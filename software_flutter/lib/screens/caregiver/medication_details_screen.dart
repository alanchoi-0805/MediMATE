...
class _MedicationDetailsScreenState extends State<MedicationDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot>(
        stream:
            _firestore.collection('users').doc(widget.targetUserId).snapshots(),
        builder: (context, snapshot) {
          ...
          final bool hasData = medication != null &&
              (medication['medicineName'] != null &&
                  medication['medicineName'].toString().isNotEmpty);

          return Column(
            children: [
              // --- HEADER ---
              Container(
                padding: const EdgeInsets.fromLTRB(8, 25, 24, 10),
  ...
  Widget _buildDetailsView(Map<String, dynamic> med) {
    final String type = med['medicationType'] ?? 'Pills';
    final String name = med['medicineName'] ?? 'Unknown';
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        "slot_label".tr(args: [widget.selectedSlot.toString()]),
                        style: const TextStyle(
